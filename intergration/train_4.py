...
while episode_count<2000000:  # Run until solved
	...
	if episode_count%100 ==0:
		print("model4_thru episode %d running reward %f" %(episode_count, running_reward))
	if episode_count%5000==0:
		np.save('model4_thru_episode_history', episode_reward_history)
		print("reward history saved")
		try:
			model.save('simplemodel2_model4_thru') # only one task
			model_target.save('simplemodel2_target_model4_thru')
